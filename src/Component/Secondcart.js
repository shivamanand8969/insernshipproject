...
const Secondcart = (props) => {
    return (
        <div className='w-[692px] h-[472px] shadow-xl border-[1px] border-[#E0E0E0] mt-[30px]'>
            <div>
               {props.image ? <img src={props.image} className='h-[220px] w-[692px]' /> : null}
            </div>
            <div className='ml-5'>
                ...
                <div className='mt-[10px] font-[IBM Plex Sans] font-[400] text-[19px] text-[#5C5C5C]'>
                    <p>
                        <button className='w-[630px] ml-3 h-8 rounded-[4px] flex justify-center items-center border-[1px] border-red-500'>{props.button}</button>             </p>
                </div>
